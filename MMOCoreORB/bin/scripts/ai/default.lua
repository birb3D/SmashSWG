...
healDefault = {
	...
	{id="275430758",	name="If",	pid="2638573300"},
	{id="3472761008",	name="CheckMovementState",	pid="275430758",	args={condition=LAIR_HEALING}},
...
rootDefault = {
	...
	{id="4019771811",	name="Sequence",	pid="714360210"},
	{id="1217152784",	name="Selector",	pid="4019771811"},
	{id="71832852",	name="If",	pid="1217152784"},
	{id="2428469171",	name="CheckIsInCombat",	pid="71832852"},
	{id="3808000558",	name="If",	pid="1217152784"},
	{id="4240051443",	name="CheckMovementState",	pid="3808000558",	args={condition=LAIR_HEALING}},
	{id="2882182450",	name="Not",	pid="4019771811"},
	{id="3260762499",	name="If",	pid="2882182450"},
	{id="2083558294",	name="CheckPosture",	pid="3260762499",	args={condition=KNOCKEDDOWN}},
	{id="1083123564",	name="TreeSocket",	pid="4019771811",	args={slot=HEAL}},
	...
	{id="2432224167",	name="Not",	pid="2466392703"},
	{id="102652489",	name="If",	pid="2432224167"},
	{id="3019683194",	name="CheckMovementState",	pid="102652489",	args={condition=LAIR_HEALING}},
