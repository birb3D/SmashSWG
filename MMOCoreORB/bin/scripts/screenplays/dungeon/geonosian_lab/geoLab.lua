...
function GeonosianLab:spawnMobiles()
	...
	spawnMobile("yavin4", "geonosian_scientist", 300, -118.4,-20,-39.2,175,1627790)
	...
	if isZoneEnabled("corellia") then
		spawnMobile("corellia", "herald_biogenic_teraeza", 300, 21.3645, 1.28309, 9.48413, 142.744, 1935823)
	end

	if isZoneEnabled("naboo") then
		spawnMobile("naboo", "herald_biogenic_harmon", 300, 5094, -192, 6754, -173, 0)
	end

	spawnMobile("yavin4", "herald_biogenic_gardo", 300, -3.8, 0.1, -3.8, 88, 1713374)
end
