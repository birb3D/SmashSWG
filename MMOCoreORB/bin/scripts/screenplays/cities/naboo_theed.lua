NabooTheedScreenPlay = CityScreenPlay:new {
	...
	patrolMobiles = {
		...
		--Cantina
		{"cantina_1", "r3", 6.0, -0.894992 , 7.2, 100, 91, "", false},
		{"cantina_2", "patrolNpc", 8, -0.894992 , -8.7, 100, 91, "playful", false},
		{"cantina_3", "patrolNpc", -5.11,-0.894992,6.8, 300, 91, "conversation", false},
		{"cantina_4", "patrolNpc", -7.2,-0.894992,-6, 300, 91, "conversation", false},
		...
		{"starport_walk_3", "r3", 34,0.7,-72.2,50,1692103, "playful", false},
		...
		{"starport_walk_9", "cll8_binary_load_lifter", 12.8622,7.9418,-39.8957, 0, 1692104, "", false},
		...
		{"npc_walk_8", "patrolNpc", -4911,6,4066,300,0, "", false},
		{"npc_walk_9", "patrolNpc", -4900,6,4065,300,0, "", false},
		{"npc_walk_10", "r3", -4901,6,4064,300,0, "", false},
		{"npc_walk_11", "patrolNpc", -4902,6,4063,300,0, "", false},
		{"npc_walk_12", "patrolNpc", -4903,6,4062,300,0, "", false},
		{"npc_walk_13", "surgical_droid_21b", -4904,6,4061,300,0, "", false},
		{"npc_walk_14", "patrolNpc", -4905,6,4060,300,0, "", false},
		{"npc_walk_15", "patrolNpc", -4906,6,4099,300,0, "", false},
		{"npc_walk_16", "patrolNpc", -4907,6,4098,300,0, "", false},
		{"npc_walk_17", "r4", -4908,6,4097,300,0, "", false},
		{"npc_walk_18", "patrolNpc", -4909,6,4096,300,0, "", false},
		{"npc_walk_19", "patrolNpc", -4910,6,4095,300,0, "happy", false},
		{"npc_walk_19", "protocol_droid_3po", -5008,6,4249,300,0, "", false},
		{"npc_walk_20", "patrolNpc", -5002,6,4249,300,0, "happy", false},
		{"npc_walk_21", "r2", -5010,6,4249,300,0, "", false},
		{"npc_walk_22", "patrolNpc", -5011,6,4249,300,0, "happy", false},
		{"npc_walk_23", "eg6_power_droid", -4952, 6, 4121,300,0, "happy", false},
		{"npc_walk_24", "eg6_power_droid", -4950, 6, 4124,300,0, "happy", false},
		{"npc_walk_25", "eg6_power_droid", -4953, 6, 4123,300,0, "happy", false},
		...
		{"npc_walk_37", "patrolNpc", -5145, 6, 4267,300,0, "happy", false},
		{"npc_walk_38", "patrolNpc", -5139, 6, 4261,300,0, "happy", false},
		{"npc_walk_39", "patrolNpc", -5071, 6, 4251,300,0, "happy", false},
		{"npc_walk_40", "patrolNpc", -5069, 6, 4249,300,0, "happy", false},
		{"npc_walk_41", "patrolNpc", -5108, 6, 4186,300,0, "happy", false},
		{"npc_walk_42", "protocol_droid_3po_red", -5008, 6, 4165,300,0, "happy", false},
		{"npc_walk_43", "surgical_droid_21b", -5093, 6, 4209,300,0, "happy", false},
	...
	patrolPoints = {
		...
		cantina_1 = {{7, -0.894992, 7.2, 91, false}, {16, -0.894992, 0, 91, false}, {5, -0.894992, -7, 91, false}, {16, -0.894992, 0, 91, false}},
		cantina_2 = {{5, -0.894992, -9, 91, false}, {3, -0.894992, -5.4, 91, false}, {12, -0.894992, -6, 91, false}, {10, -0.894992, -11, 91, false}},
		cantina_3 = {{-5.11,-0.894992,5, 91, false}, {-5.11,-0.894992,6.4, 91, false}, {0,-0.894992,6.4, 91, false}, {0,-0.894992,5, 91, true}, {-1.51,-0.894992,6.4, 91, false}, {-7.11,-0.894992,6.4, false}},
		...
		cantina_6 = {{-2.11,-0.894992,7, 91, true}, {23,-0.894992,11, 91, false}, {19.5, -0.9, 18.7, 93, false}},
		cantina_7 = {{39.13, 0.1, 1.27, 89, true}, {14, -0.894992 , 0, 91, false}},
		cantina_8 = {{14.3, -0.894992 , 2, 91, false}, {42.73, 0.1, 2.47, 89, true}},
		cantina_9 = {{41.73, 0.1, 0, 89, true}, {14, -0.894992 , -1.2, 91, false}},
		...
		npc_walk_4 = {{-5006,6,4085,0, false}, {-5052,6,4140,0, false}, {-5064,6,4164,0, false}, {-5082,6,4212,0, false}, {-5078,6,4296,0, false}, {-5082,6,4212,0, false}, {-5064,6,4164,0, false}},
		...
		npc_walk_8 = { {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false}, {-4833, 6, 4105, 0, false}, {-4955, 6, 4120, 0, false} },
		npc_walk_9 = { {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false}, {-4935, 6, 4147, 0, false}, {-4909, 6, 4092, 0, false}, {-4875, 6, 4067, 0, false} },
		npc_walk_10 = { {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false}, {-4935, 6, 4147, 0, false}, {-4909, 6, 4092, 0, false}, {-4875, 6, 4067, 0, false}, {-4871, 6, 4185, 0, false} },
		npc_walk_11 = { {-4922, 6, 4092, 0, false}, {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false}, {-4953, 6, 4123, 0, false} },
		npc_walk_12 = { {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false}, {-4833, 6, 4105, 0, false}, {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false} },
		...
		npc_walk_20 = { {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false}, {-4935, 6, 4147, 0, false}, {-4909, 6, 4092, 0, false} },
		npc_walk_21 = { {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false}, {-4833, 6, 4105, 0, false}, {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false} },
		npc_walk_22 = { {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false}, {-4833, 6, 4105, 0, false}, {-4955, 6, 4120, 0, false}, {-4953, 6, 4123, 0, false}, {-4935, 6, 4147, 0, false} },
		npc_walk_23 = { {-4875, 6, 4067, 0, false}, {-4909, 6, 4092, 0, false}, {-4922, 6, 4092, 0, false}, {-4824, 6, 4096, 0, false} },
		npc_walk_24 = { {-4909, 6, 4092, 0, false}, {-4959, 6, 4117, 0, false}, {-4936, 6, 4149, 0, false}, {-4922, 6, 4092, 0, false}, {-4824, 6, 4096, 0, false} },
		npc_walk_25 = { {-4933, 6, 4070, 0, false}, {-4936, 6, 4149, 0, false}, {-4922, 6, 4092, 0, false}, {-4824, 6, 4096, 0, false}, {-4835, 6, 4084, 0, false} },
		...
		npc_walk_37 = { {-5145, 6, 4267, 0, false}, {-5199, 6, 4199, 0, false}, {-5223, 6, 4215, 0, false}, {-5245, 6, 4233, 0, false}, {-5178, 6, 4316, 0, false} },
		npc_walk_38 = { {-5139, 6, 4261, 0, false}, {-5191, 6, 4192, 0, false}, {-5225, 6, 4217, 0, false}, {-5249, 6, 4236, 0, false}, {-5174, 6, 4322, 0, false} },
		npc_walk_39 = { {-5071, 6, 4251, 0, false}, {-5036, 6, 4216, 0, false}, {-4984, 6, 4214, 0, false}, {-4938, 6, 4184, 0, false}, {-4886, 6, 4137, 0, false}, {-4938, 6, 4184, 0, false} },
		npc_walk_40 = { {-5069, 6, 4249, 0, false}, {-5034, 6, 4214, 0, false}, {-4982, 6, 4212, 0, false}, {-4936, 6, 4182, 0, false}, {-4884, 6, 4135, 0, false}, {-4936, 6, 4182, 0, false} },
		npc_walk_41 = { {-5108, 6, 4186, 0, false}, {-5049, 6, 4219, 0, false}, {-5090, 6, 4254, 0, false}, {-5126, 6, 4236, 0, false}, {-5093, 6, 4209, 0, false} },
		npc_walk_42 = { {-5008, 6, 4165, 0, false}, {-5134, 6, 4203, 0, false}, {-5108, 6, 4186, 0, false}, {-5064, 6, 4164, 0, false} },
		npc_walk_43 = { {-5093, 6, 4209, 0, false}, {-5110, 6, 4192, 0, false}, {-5074, 6, 4140, 0, false}, {-5008, 6, 4165, 0, false} },

	},

	crowdMobiles = {
		{ "eg6_power_droid", "happy"},
		{ "eg6_power_droid", "happy"},
		{ "eg6_power_droid", "happy"},
		{ "eg6_power_droid", "happy"},
		{ "eg6_power_droid", "happy"},
	...
	mobiles = {
		...
		{"comm_operator", 400, 48.13, 0.1, 2.47, 202, 89, "calm"},
		...
		{"doikk_nats",60,24.32,-0.894992,11.47,200.0013,91, "themepark_music_3"},
		{"figrin_dan",60,25.69,-0.894992,9.4,-40,91, "themepark_music_3"},
	    {"nalan_cheel",60,22.54,-0.894992,12.13,130.0011,91, "themepark_music_1"},
		-- 5 people around bar right front side to center back
	    {"commoner_naboo",60,3.11,0,5.4,161.005,91, "bored"},
		{"commoner_naboo",60,1.11,0,5.4,330.024,91, "npc_standing_drinking"},
		{"commoner_naboo",60,-3.11,0,5.4,16.6733,91, "npc_standing_drinking"},
		{"commoner_tatooine",60,4.11,-0.894992,5.4,158.443,91, "npc_standing_drinking"},
		{"patron",60,-4.11,-0.894992,5.4,26.8951,91, "happy"},
		-- Far left cell nearest to door 2 people talking
		{"corellia_times_investigator", 300, 20.6, -0.9, -18.6, 180, 92, "conversation"},
		{"commoner_technician", 300, 20.6, -0.9, -19.6, 0, 92, "conversation"},
		-- 3 people far right room nearest to door
		{"brawler", 60, 22.6, -0.9, 19.6, 0, 93, "npc_consoling"},
		{"commoner", 60, 21.5, -0.9, 20.7, 135, 93, "sad"},
		{"farmer_rancher", 300, 22.6, -0.9, 20.7, 180, 93, "npc_consoling"},
		-- far left middle cell 2 guys talking around the corner
		{"farmer", 60, 10.9, -0.9, -13.9, 180, 94, "conversation"},
		{"mercenary", 300, 10.9, -0.9, -15.0, 0, 94, "conversation"},
		-- 1 person far left back cell nearest to back door
		{"noble",60,-42.098,0.105009,-23.0786,180.012,103, "conversation"},
		{"mercenary",300,-42.098,0.105009,-24.1786,0,103, "nervous"},
