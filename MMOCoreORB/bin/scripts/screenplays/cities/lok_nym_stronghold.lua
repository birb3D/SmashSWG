LokNymStrongholdScreenPlay = CityScreenPlay:new {
	...
	patrolMobiles = {
		...
		--Cantina
		{"cantina_1", "r3", 6.0, -0.894992 , 7.2, 100, 8145378, "", false},
		{"cantina_2", "patrolNpc", 8, -0.894992 , -8.7, 100, 8145378, "playful", false},
		{"cantina_3", "patrolNpc", -5.11,-0.894992,6.8, 300, 8145378, "conversation", false},
		{"cantina_4", "patrolNpc", -7.2,-0.894992,-6, 300, 8145378, "conversation", false},
		{"cantina_5", "patrolNpc", 21.32,-0.894992,10.47, 300, 8145378, "happy", false},
		{"cantina_6", "patrolNpc", -4.11,-0.894992,7, 300, 8145378, "happy", false},
		{"cantina_7", "patrolNpc", 40.13, 0.1, 1.47, 300, 8105494, "playful", false},
		{"cantina_8", "patrolNpc", 14.3, -0.894992, 2, 200, 8145378, "playful", false},
	...
	patrolPoints = {
		...
		cantina_1 = {{7, -0.894992 , 7.2, 8145378, false}, {16, -0.894992 , 0, 8145378, false}, {5, -0.894992 , -7, 8145378, false}, {16, -0.894992 , 0, 8145378, false}},
		cantina_2 = {{5, -0.894992 , -9, 8145378, false}, {3, -0.894992 , -5.4, 8145378, false}, {12, -0.894992 , -6, 8145378, false}, {10, -0.894992 , -11, 8145378, false}},
		cantina_3 = {{-5.11,-0.894992,5, 8145378, false}, {-5.11,-0.894992,6.4, 8145378, false}, {0,-0.894992,6.4, 8145378, false}, {0,-0.894992,5, 8145378, 8145378, true}, {-1.51,-0.894992,6.4, 8145378, false}, {-7.11,-0.894992,6.4, 8145378, false}},
		cantina_4 = {{-7.2,-0.894992,-5, 8145378, false}, {-7.2,-0.894992,-6.4, 8145378, false}, {-4.3,-0.894992,-6.4, 8145378, false}, {-4.3,-0.894992,-5, 8145378, 8145378, false}, {-4.3,-0.894992,-6.4, 8145378, false}, {-7.2,-0.894992,-6.4, 8145378, false}, {-8.2,-0.894992,-11.4, 8145378, false}},
		cantina_5 = {{23.32,-0.894992,10.47, 8145378, false}, {21,-0.894992,-8.47, 8145378, false}, {20, -0.894992 , -1.4, 8145378, true}},
		cantina_6 = {{-2.11,-0.894992,7, 8145378, true}, {23,-0.894992,11, 8145378, false}, {19.5, -0.9, 18.7, 8145380, false}},
		cantina_7 = {{39.13, 0.1, 1.27, 8145376, true}, {14, -0.894992 , 0, 8145378, false}},
		cantina_8 = {{14.3, -0.894992, 2, 8145378, false}, {42.73, 0.1, 2.47, 8145376, true}},
		cantina_9 = {{41.73, 0.1, 0, 8145376, true}, {14, -0.894992 , -1.2, 8145378, false}},
	},
...
crowdPoints = {
	...
	mobiles = {
		...
		{"mercenary",300,21.7848,-0.894993,-8.75091,180.009,8145378, "conversation"},
		{"mercenary",300,20.6848,-0.894992,-8.75091,135.009,8145378, "angry"},
		{"shadowy_figure",300,23.1893,-0.894993,9.8231,180.01,8145378, "angry"},
		{"doikk_nats",60,24.32,-0.894992,11.47,200.0013,8145378, "themepark_music_3"},
		{"figrin_dan",60,25.69,-0.894992,9.4,-40,8145378, "themepark_music_3"},
	    {"nalan_cheel",60,22.54,-0.894992,12.13,130.0011,8145378, "themepark_music_1"},
