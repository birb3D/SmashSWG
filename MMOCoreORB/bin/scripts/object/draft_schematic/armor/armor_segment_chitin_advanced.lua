...
object_draft_schematic_armor_armor_segment_chitin_advanced = object_draft_schematic_armor_shared_armor_segment_chitin_advanced:new {
	...
	ingredientTitleNames = {"armor_segment_chitin", "segment_mounting_tabs", "defensive_layer", "segment_enhancement"},
	ingredientSlotType = {0, 0, 3, 3},
	resourceTypes = {"bone_mammal_dantooine", "iron_doonium", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_base_armor_segment_enhancement.iff"},
	resourceQuantities = {25, 8, 1, 1},
