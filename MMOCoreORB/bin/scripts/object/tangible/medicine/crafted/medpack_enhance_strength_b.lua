...
object_tangible_medicine_crafted_medpack_enhance_strength_b = object_tangible_medicine_crafted_shared_medpack_enhance_strength_b:new {
	gameObjectType = 8238,
	...
	experimentalMin = {0, 0, 10, 5, 1200, 70, 100},
	experimentalMax = {0, 0, 100, 15, 7200, 55, 150},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_strength_b, "object/tangible/medicine/crafted/medpack_enhance_strength_b.iff")
