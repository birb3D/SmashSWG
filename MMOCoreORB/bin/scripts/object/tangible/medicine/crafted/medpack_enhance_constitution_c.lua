...
object_tangible_medicine_crafted_medpack_enhance_constitution_c = object_tangible_medicine_crafted_shared_medpack_enhance_constitution_c:new {
	gameObjectType = 8238,
	...
	experimentalMin = {0, 0, 20, 5, 1200, 80, 1000},
	experimentalMax = {0, 0, 200, 20, 10800, 60, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_constitution_c, "object/tangible/medicine/crafted/medpack_enhance_constitution_c.iff")
