...
object_tangible_medicine_crafted_medpack_enhance_quickness_d = object_tangible_medicine_crafted_shared_medpack_enhance_quickness_d:new {
	gameObjectType = 8238,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_enhance_quickness_d, "object/tangible/medicine/crafted/medpack_enhance_quickness_d.iff")
