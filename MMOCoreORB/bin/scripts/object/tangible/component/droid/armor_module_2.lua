...
object_tangible_component_droid_armor_module_2 = object_tangible_component_droid_shared_armor_module_2:new {
	...
	experimentalMin = {0, 0, 5, 1000, -10, 200, 2},
	experimentalMax = {0, 0, 15, 1000, 15, 600, 4},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 4, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_droid_armor_module_2, "object/tangible/component/droid/armor_module_2.iff")
