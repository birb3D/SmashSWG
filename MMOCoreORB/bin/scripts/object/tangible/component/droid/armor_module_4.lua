...
object_tangible_component_droid_armor_module_4 = object_tangible_component_droid_shared_armor_module_4:new {
	...
	experimentalMin = {0, 0, 5, 1000, -10, 600, 4},
	experimentalMax = {0, 0, 15, 1000, 15, 1200, 6},
