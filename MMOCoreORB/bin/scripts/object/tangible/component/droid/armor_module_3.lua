...
object_tangible_component_droid_armor_module_3 = object_tangible_component_droid_shared_armor_module_3:new {
	...
	experimentalMin = {0, 0, 5, 1000, -10, 300, 3},
	experimentalMax = {0, 0, 15, 1000, 15, 900, 5},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 4, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_droid_armor_module_3, "object/tangible/component/droid/armor_module_3.iff")
